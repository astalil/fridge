<template>
  <div class="container">
            ...
            <div class="flex flex-column h-full">
                <div class="flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0">
                    <span class="inline-flex align-items-center gap-2">
                        ...
                        <span class="font-semibold text-2xl text-primary">FreshAlert</span>
                    </span>
                    <span>
                ...
                <div class="overflow-y-auto">
                    <ul class="list-none p-3 m-0">
                        ...
                        <li>
                            <a v-ripple href="list" class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                                <i class="pi pi-users mr-2"></i>
                                <span class="font-medium">Fridges list</span>
                            </a>
                        </li>
                        <li>
                            <a href="invites" v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                ...
                <div class="mt-auto">
                    <div v-if="userStore.user.isAuthenticated">
                        <a v-ripple href="logout" class="m-3 flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                    ...
                    <div v-else>
                        <a v-ripple href="login" class="m-3 flex align-items-center cursor-pointer p-3 gap-2 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                            SIgn In
                        </a>
                    </div>
    ...
    <Button icon="pi pi-bars" id="navbar-burger" @click="visible = true" />
</nav>
